...
exports.handler = function(event, context) {
    ...
    let intentParams = [
        ...
        {
            "name": "EgoliEmployeeCreateIncident" + "_" + process.env.ENV,
            ...
            "fulfillmentLambda": {
                "region": "us-east-1",
                "accountId": "253655748453",
                "lambdaArn": "arn:aws:lambda:us-east-1:253655748453:function:SpaceCreateAppsyncCOVIDQuestionnaire-staging",
                "lambdaName": "SpaceCreateAppsyncCOVIDQuestionnaire-staging",
            },
            "fulfillmentActivity": {
                "type": "CodeHook",
                "codeHook": {
                    "messageVersion": "1.0",
                    "uri": "arn:aws:lambda:us-east-1:253655748453:function:SpaceCreateAppsyncCOVIDQuestionnaire-staging"
                }
            }, 
    ...
    let botParams = {
        ...
        "intents": [
            ...
            {
                "intentName": "EgoliEmployeeCreateIncident" + "_" + process.env.ENV,
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "7b76e567",
